 ...
 * 
 * Also, I am using blake2s to hash the passwords. It is faster
 * than bcryptjs and more secure [1].
 * 
 * References:
 *      [1] Me.
 */
...
userSchema.methods.createAuthToken = async function () {
    const user = this
    const token = jwt.sign({ _id: user._id.toString(), admin: user.admin }, process.env.JWT_SECRET)
